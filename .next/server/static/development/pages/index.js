...
const Index = props => {
  ...
  }, products.length ? products.map(product => __jsx(_components_Product__WEBPACK_IMPORTED_MODULE_4__["default"], {
    product: product,
    key: product.id
  })) : ''));
};
...
module.exports = __webpack_require__(/*! /Users/tassi_dondup/Sites/Headless-Wordpress-NextJS-Ecommerece/pages/index.js */"./pages/index.js");
